...
onTouchStart={(e) => { if (e.target.tagName === ‘INPUT’ || e.target.tagName === ‘SELECT’ || e.target.closest(’[data-drag-handle]’)) return; handleStart(e.touches[0].clientX); }}
onTouchMove={(e) => { if (startX !== null) handleMove(e.touches[0].clientX); }}
onTouchEnd={handleEnd}
onMouseDown={(e) => { if (e.target.tagName === ‘INPUT’ || e.target.tagName === ‘SELECT’) return; if (e.target.closest(’[data-drag-handle]’)) return; e.preventDefault(); handleStart(e.clientX); }}
...
const plannerDragRef = useRef({ active: false, fromId: null, rowEls: {} });
...
{activeTheme === ‘pipboy’ && <style>{`@import url('https://fonts.googleapis.com/css2?family=Share+Tech+Mono&display=swap'); *, ::before, ::after { border-color: rgba(0,255,0,0.15) !important; } .min-h-screen { background: #000 !important; background-image: repeating-linear-gradient(0deg, rgba(0,255,0,0.03) 0px, rgba(0,255,0,0.03) 1px, transparent 1px, transparent 3px), radial-gradient(ellipse at 50% 30%, rgba(0,80,0,0.35) 0%, transparent 70%) !important; } .min-h-screen::after { content: ''; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: repeating-linear-gradient(0deg, rgba(0,0,0,0.15) 0px, rgba(0,0,0,0.15) 1px, transparent 1px, transparent 2px); pointer-events: none; z-index: 9999; } h1, h2, h3, h4, h5, h6, p, span, label, a, button, th, td, li, div { color: #00ff00 !important; text-shadow: 0 0 8px rgba(0,255,0,0.4), 0 0 2px rgba(0,255,0,0.2) !important; } input, select, textarea { background: rgba(0,20,0,0.8) !important; color: #00ff00 !important; border-color: rgba(0,255,0,0.3) !important; text-shadow: 0 0 5px rgba(0,255,0,0.3) !important; caret-color: #00ff00 !important; } input::placeholder, select option { color: rgba(0,255,0,0.4) !important; } svg { color: #00ff00 !important; filter: drop-shadow(0 0 3px rgba(0,255,0,0.3)); } [class*="bg-gray-"], [class*="bg-slate-"], [class*="bg-white"], [class*="bg-blue-50"], [class*="bg-purple-50"], [class*="bg-emerald-50"], [class*="bg-amber-50"], [class*="bg-rose-50"], [class*="bg-cyan-50"], [class*="bg-green-50"], [class*="bg-indigo-50"], [class*="bg-red-50"], [class*="bg-yellow-50"], [class*="bg-orange-50"], [class*="bg-pink-50"] { background: rgba(0,20,0,0.6) !important; } [class*="bg-indigo-600"], [class*="bg-indigo-700"] { background: rgba(0,180,0,0.3) !important; border: 1px solid rgba(0,255,0,0.4) !important; } [class*="bg-rose-"], [class*="bg-red-"] { background: rgba(0,60,0,0.5) !important; } [class*="text-gray-"], [class*="text-slate-"], [class*="text-white"], [class*="text-indigo-"], [class*="text-rose-"], [class*="text-amber-"], [class*="text-cyan-"], [class*="text-emerald-"], [class*="text-green-"], [class*="text-blue-"], [class*="text-purple-"] { color: #00ff00 !important; } .rounded-2xl, .rounded-xl, .rounded-lg { border-radius: 4px !important; }`}</style>}
{activeTheme === ‘comic’ && <style>{`@import url('https://fonts.googleapis.com/css2?family=Bangers&display=swap'); .min-h-screen { background: #87ceeb !important; background-image: radial-gradient(circle, rgba(0,0,0,0.06) 1px, transparent 1px), repeating-conic-gradient(from 0deg at 50% 50%, rgba(255,255,255,0.08) 0deg 10deg, transparent 10deg 20deg) !important; background-size: 8px 8px, 100% 100% !important; } h1, h2, h3, h4, h5 { color: #000 !important; text-shadow: 2px 2px 0 #fbbf24, -1px -1px 0 #000 !important; letter-spacing: 1px !important; } .rounded-2xl, .rounded-xl { border-radius: 0 !important; } input, select, textarea { background: #fffde7 !important; border: 2px solid #000 !important; border-radius: 0 !important; font-family: 'Bangers', 'Comic Sans MS', cursive !important; } button { text-transform: uppercase !important; letter-spacing: 1px !important; }`}</style>}
{activeTheme === ‘newspaper’ && <style>{`@import url('https://fonts.googleapis.com/css2?family=Special+Elite&display=swap'); .min-h-screen { background: #f5f0e1 !important; background-image: url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence baseFrequency='0.65' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)' opacity='0.04'/%3E%3C/svg%3E"), repeating-linear-gradient(0deg, transparent 0px, transparent 28px, rgba(92,58,30,0.06) 28px, rgba(92,58,30,0.06) 29px) !important; } *, ::before, ::after { border-color: rgba(92,58,30,0.2) !important; } h1, h2, h3, h4, h5, h6, p, span, label, a, button, th, td, li, div { font-family: 'Special Elite', 'Courier New', monospace !important; color: #3d2b1f !important; } h1, h2, h3 { letter-spacing: 1.5px !important; text-transform: uppercase !important; } input, select, textarea { font-family: 'Special Elite', 'Courier New', monospace !important; background: rgba(245,240,225,0.9) !important; color: #3d2b1f !important; border: 1px solid rgba(92,58,30,0.3) !important; border-radius: 0 !important; box-shadow: inset 1px 1px 3px rgba(92,58,30,0.1) !important; } input::placeholder { color: rgba(61,43,31,0.4) !important; font-style: italic !important; } svg { color: #5c3a1e !important; } .rounded-2xl, .rounded-xl, .rounded-lg { border-radius: 0 !important; } [class*="bg-indigo-600"], [class*="bg-indigo-700"] { background: #5c3a1e !important; border-radius: 0 !important; } [class*="border-b-2"][class*="border-indigo-600"] { border-color: #5c3a1e !important; }`}</style>}
{activeTheme === ‘papyrus’ && <style>{`@import url('https://fonts.googleapis.com/css2?family=Amatic+SC:wght@400;700&family=IM+Fell+English:ital@0;1&display=swap'); .min-h-screen { background: #d4a56a !important; background-image: url("data:image/svg+xml,%3Csvg width='300' height='300' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence baseFrequency='0.4' numOctaves='5' stitchTiles='stitch'/%3E%3CfeColorMatrix type='saturate' values='0'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)' opacity='0.12'/%3E%3C/svg%3E") !important; } *, ::before, ::after { border-color: rgba(120,53,15,0.25) !important; } h1, h2, h3, h4, h5, h6 { font-family: 'Amatic SC', 'Papyrus', fantasy !important; color: #451a03 !important; font-weight: 700 !important; font-size: 1.4em !important; letter-spacing: 2px !important; text-transform: uppercase !important; text-shadow: none !important; } h1 { font-size: 1.8em !important; } p, span, label, a, button, th, td, li, div { font-family: 'IM Fell English', 'Palatino Linotype', serif !important; color: #3b1a04 !important; text-shadow: none !important; } header h1, header p, header span { color: #fef3c7 !important; } input, select, textarea { background: rgba(212,165,106,0.5) !important; color: #3b1a04 !important; border: 1px solid rgba(120,53,15,0.3) !important; border-radius: 0 !important; font-family: 'IM Fell English', serif !important; } input::placeholder { color: rgba(59,26,4,0.4) !important; font-style: italic !important; } svg { color: #78350f !important; filter: none !important; } .rounded-2xl, .rounded-xl, .rounded-lg { border-radius: 0 !important; } [class*="bg-gray-"], [class*="bg-slate-"], [class*="bg-white"], [class*="bg-blue-50"], [class*="bg-purple-50"], [class*="bg-emerald-50"], [class*="bg-amber-50"], [class*="bg-rose-50"], [class*="bg-cyan-50"], [class*="bg-green-50"], [class*="bg-indigo-50"] { background: rgba(190,140,80,0.35) !important; } [class*="bg-indigo-600"], [class*="bg-indigo-700"] { background: #78350f !important; border-radius: 0 !important; } /* Decorative border on cards */ [class*="shadow-inner"] { border: 2px solid rgba(120,53,15,0.2) !important; box-shadow: inset 0 0 20px rgba(120,53,15,0.08) !important; }`}</style>}
{activeTheme === ‘lionheart’ && <style>{`@import url('https://fonts.googleapis.com/css2?family=MedievalSharp&family=Cinzel:wght@400;600;700&display=swap'); .min-h-screen { background: #1a0a0a !important; background-image: url("data:image/svg+xml,%3Csvg width='60' height='60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 5 L35 15 L30 12 L25 15 Z' fill='rgba(202,138,4,0.04)'/%3E%3Cpath d='M5 30 L15 35 L12 30 L15 25 Z' fill='rgba(202,138,4,0.03)'/%3E%3Cpath d='M55 30 L45 25 L48 30 L45 35 Z' fill='rgba(202,138,4,0.03)'/%3E%3Cpath d='M30 55 L25 45 L30 48 L35 45 Z' fill='rgba(202,138,4,0.04)'/%3E%3C/svg%3E"), linear-gradient(180deg, #2d0a0a 0%, #1a0505 40%, #0d0505 100%) !important; background-size: 60px 60px, 100% 100% !important; } *, ::before, ::after { border-color: rgba(202,138,4,0.2) !important; } h1, h2, h3, h4, h5, h6 { font-family: 'Cinzel', 'Palatino Linotype', serif !important; color: #fbbf24 !important; font-weight: 700 !important; text-transform: uppercase !important; letter-spacing: 3px !important; text-shadow: 0 2px 4px rgba(0,0,0,0.5), 0 0 15px rgba(202,138,4,0.15) !important; } p, span, label, a, button, th, td, li, div { font-family: 'MedievalSharp', 'Palatino Linotype', serif !important; color: #fde68a !important; text-shadow: none !important; } input, select, textarea { background: rgba(26,10,10,0.9) !important; color: #fde68a !important; border: 1px solid rgba(202,138,4,0.3) !important; font-family: 'MedievalSharp', serif !important; } input::placeholder { color: rgba(253,230,138,0.3) !important; } svg { color: #ca8a04 !important; filter: drop-shadow(0 0 2px rgba(202,138,4,0.2)); } [class*="bg-gray-"], [class*="bg-slate-"], [class*="bg-white"], [class*="bg-blue-50"], [class*="bg-purple-50"], [class*="bg-emerald-50"], [class*="bg-amber-50"], [class*="bg-rose-50"], [class*="bg-cyan-50"], [class*="bg-green-50"], [class*="bg-indigo-50"] { background: rgba(26,10,10,0.7) !important; } [class*="bg-indigo-600"], [class*="bg-indigo-700"] { background: linear-gradient(135deg, #92400e, #78350f) !important; border: 1px solid rgba(202,138,4,0.4) !important; } /* Gold decorative borders on cards */ [class*="rounded-2xl"] { border: 2px solid rgba(202,138,4,0.25) !important; box-shadow: 0 0 10px rgba(202,138,4,0.05), inset 0 0 15px rgba(0,0,0,0.2) !important; } /* Tab active = gold underline */ [class*="border-b-2"][class*="border-indigo-600"] { border-color: #ca8a04 !important; }`}</style>}
{activeTheme === ‘fifties’ && <style>{`.min-h-screen { background: linear-gradient(135deg, #fce7f3 0%, #e0f2fe 50%, #d1fae5 100%) !important; }`}</style>}
              ...
              return sortedPlannerItems.map((item) => {
                ...
                const handleGripPointerDown = (e) => {
                  ...
                  const onMove = (clientY) => {
                    ...
                    let hoverId = null;
                    Object.entries(drag.rowEls).forEach(([id, el]) => {
                      if (!el) return;
                      const r = el.getBoundingClientRect();
                      if (clientY >= r.top && clientY <= r.bottom) hoverId = id;
                    });
                    if (hoverId && hoverId !== drag.fromId) {
                      drag.overId = hoverId;
                  ...
                  const onEnd = () => {
                    if (drag.active && drag.fromId && drag.overId && drag.fromId !== drag.overId) {
                      reorderPlannerItem(drag.fromId, drag.overId);
                    }
                    drag.active = false;
                    drag.fromId = null;
                    drag.overId = null;
                ...
                return (
                  ...
                  >
                    <div
                      ref={el => { plannerDragRef.current.rowEls[item.id] = el; }}
                      className={`flex items-center gap-3 py-3 px-4 border rounded-xl transition ${
                        dragOverItemId === item.id
                          ? "border-indigo-400 bg-indigo-50/60"
                          : draggedItemId === item.id
                            ? "opacity-50 border-dashed border-indigo-300"
                            : item.paid
                    ...
                    >
                      {/* Drag handle */}
                      <div className="flex-shrink-0 touch-none" data-drag-handle
